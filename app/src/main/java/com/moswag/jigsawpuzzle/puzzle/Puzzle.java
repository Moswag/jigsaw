...
import com.moswag.jigsawpuzzle.cutter.CutMap;
import com.moswag.jigsawpuzzle.cutter.ImageCutter;
...
public class Puzzle {
    ...
    private void getDisplaySize(Bitmap bitmap, int widthFinal, int heightFinal, final ImageView imageView) {
        Bitmap image = null;
        try {
            image = BitmapFactory.decodeResource(mActivity.getResources(), R.drawable.image);
